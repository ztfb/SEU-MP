<template>
  <div class="login-wrap">
    <el-form class="login-container">
      ...
      <el-form-item>
        <el-input type="text" placeholder="昵称" v-model="nickName" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input type="textarea" :rows="2" placeholder="请输入注册码" v-model="content"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button style="float: left;width: 35%" type="primary" @click="register" >注册</el-button>
        <el-button style="float:right;width: 35%" type="primary" @click="login" >返回</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    register: function () {
      ...
      } else if (this.nickName === '' || this.nickName === null || this.nickName === undefined) {
